...
String temp_humidity_distance_measured();
...
void loop() {
  ...
  Serial.println(temp_humidity_distance_measured());
...
String temp_humidity_distance_measured() {
    ...
    String dht;
    dht = String(dht + "status \"humidity\":\"" + DHT.humidity + "%\",\"temperature\":" + DHT.temperature + ",\"distance\":" + distance);
